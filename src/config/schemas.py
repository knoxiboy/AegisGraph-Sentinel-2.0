...
class EnvironmentVariablesSchema(ConfigBaseModel):
    ...
    redis_max_connections: Optional[str] = Field(default=None, description="Redis connection pool size.")
    redis_socket_timeout: Optional[str] = Field(default=None, description="Redis socket timeout in seconds.")
    redis_socket_connect_timeout: Optional[str] = Field(default=None, description="Redis socket connect timeout in seconds.")
    redis_retry_on_timeout: Optional[str] = Field(default=None, description="Enable Redis retry_on_timeout.")
    redis_health_check_interval: Optional[str] = Field(default=None, description="Redis health check interval in seconds.")
    redis_socket_keepalive: Optional[str] = Field(default=None, description="Enable Redis socket keepalive.")
    ...
    neo4j_enabled: Optional[str] = Field(default=None, description="Enable Neo4j integration.")
    neo4j_max_connection_pool_size: Optional[str] = Field(default=None, description="Neo4j max connection pool size.")
    neo4j_connection_timeout: Optional[str] = Field(default=None, description="Neo4j connection timeout in seconds.")
    neo4j_connection_acquisition_timeout: Optional[str] = Field(default=None, description="Neo4j connection acquisition timeout in seconds.")
    neo4j_max_connection_lifetime: Optional[str] = Field(default=None, description="Neo4j max connection lifetime in seconds.")
    neo4j_max_transaction_retry_time: Optional[str] = Field(default=None, description="Neo4j max transaction retry time in seconds.")
    neo4j_keep_alive: Optional[str] = Field(default=None, description="Enable Neo4j keep_alive.")
    neo4j_liveness_check_timeout: Optional[str] = Field(default=None, description="Neo4j liveness check timeout in seconds.")
...
class DatabaseConnectionSettings(ConfigBaseModel):
    redis_url: Optional[str] = Field(default=None)
    redis_max_connections: int = Field(default=50, ge=1)
    redis_socket_timeout: Optional[float] = Field(default=None, ge=0.0)
    redis_socket_connect_timeout: Optional[float] = Field(default=None, ge=0.0)
    redis_retry_on_timeout: bool = Field(default=False)
    redis_health_check_interval: Optional[int] = Field(default=None, ge=0)
    redis_socket_keepalive: bool = Field(default=False)
    ...
    neo4j_connection_timeout: Optional[float] = Field(default=None, ge=0.0)
    neo4j_connection_acquisition_timeout: Optional[float] = Field(default=None, ge=0.0)
    neo4j_max_connection_lifetime: Optional[float] = Field(default=3600.0, ge=0.0)
    neo4j_max_transaction_retry_time: Optional[float] = Field(default=None, ge=0.0)
    neo4j_keep_alive: bool = Field(default=True)
    neo4j_liveness_check_timeout: Optional[float] = Field(default=None, ge=0.0)
